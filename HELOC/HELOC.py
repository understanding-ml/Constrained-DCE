...
for current_seed in seed_range:
    ...
    configs = [
        {
            "type": "fsd",
            "lambda": 0.005,   # Penalty coefficient
            "dir_map": {"NetFractionInstallBurden": -1},   # Must shift left for Duration
...
# Save constrained Excel
wb_fsd_constraint.save("HELOC_FSDConstraint_NetFractionInstallBurden_0.005.xlsx")